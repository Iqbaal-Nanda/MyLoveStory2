...
3. Beri nama repository, misalnya `MyLoveStory` atau nama sesukamu. Pastikan pengaturan privasinya diset ke **Public**.
...
11. Tunggu 1-2 menit. Refresh halaman tersebut, dan akan muncul link website kamu di bagian atas (misalnya `https://namakamu.github.io/MyLoveStory`).
